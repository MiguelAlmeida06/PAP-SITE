    ...
    <body>
            ...
            <form action="">
                <fieldset>
                    ...
                    <div class="inputbox">
                        ...
                        <label for="name">Gmail ou Nome de Utilizador</label>
                    </div>
                    <div class="inputbox">
                        <input type="text" name="nome" id="nome" class="InputUser" required>
        ...
        <footer>
            <article class="redessociais">
                <a href="https://www.facebook.com/spaio" class="iconrs"><img src="img/facebook.svg"></a>
                <a href="https://www.instagram.com/spaiosc/" class="iconrs"><img src="img/Instagram.svg" class="iconrs"></a>
                <a href="https://www.facebook.com/spaio" class="iconrs"><img src="img/twitter.svg" class="iconrs"></a>
            </article>
            <article class="rodapé">
                <p class="inforodape"><a href="https://www.livroreclamacoes.pt/Pedido/Reclamacao">Livro de reclamação</a></p>
                <p class="inforodape"><a>Termos & condições</a></p>
                <p class="inforodape"><a>Privacidade</a></p>
                <p class="inforodape"><a>Contactos</a></p>
            </article>
            <article>
                <p class="textorodape">Site Produzido por Miguel Almeida. Proibido a utilização deste site sem permissao do São Paio SC © 2023</p>
            </article>
        </footer>
    </body>
</html>